...
| 2026-06-09 | **Präsentationsdeck: Bug-Fixes + Rebuild 37→25 Folien (final, live)** | Slider/CRM-Layout/Neural-Glow-Bugs behoben (`165460b`); Deck nach freigegebenem Konzept (`c6c04cf`) auf **25 Folien** umgebaut (`2712ff6`): pro Merge die stärkere Folie **byte-identisch** behalten (Interaktionen intakt), deutsche Titel, `totalSlides=25`, Übergaben gefixt (inkl. alter „Ralph, danke"-Bug), 37er archiviert (`00_abschlussbericht/deck37_backup.html`). 1:1-Sprechtext auf 25 (`1a47b78`). **Visual-Deep-Pass:** 18/25 Folien einzeln verifiziert (alle Layout-Muster + interaktive/gefixte/geflaggte) = perfekt; programmatisch alle 25 = 0 Konsolen-Fehler / 0 kaputte Bilder; frühere Overflow-„Flags" (5/20/21) als Mess-Artefakte bestätigt. Live deployed (Firebase `/deck`). **Scorecard §1/§2 unverändert** (Deck = statisches Artefakt, kein Haupt-Site-CWV). | OPUS PRIME (Claude Opus 4.8) |
