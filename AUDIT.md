...
- **Mobile-Performance 82** → Ziel ≥ 90: letzte Meile = Island-/Partial-Hydration der Homepage-Sektionen (Unused-JS bereits ~20 KiB, LCP mobil 3,6 s).
- **Totcode:** 2 ungenutzte Komponenten (`ParticleCanvas`, `ParallaxImage`) — nirgends importiert → entfernen (Build tree-shaked sie bereits weg; rein Repo-Hygiene). *Verifiziert 2026-06-02.*
