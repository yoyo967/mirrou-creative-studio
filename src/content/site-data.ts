...
export const PILLARS: Pillar[] = [
  {
    ...
    order: 1,
    heroImage: "/images/apex-header-performance-creative-marketing.webp",
  ...
  },
  {
    ...
    order: 2,
    heroImage: "/images/pillar-3-header-creative-testing-analytics.webp",
  ...
  },
  {
    ...
    order: 3,
    heroImage: "/images/pillar-2-header-paid-social-advertising.webp",
  ...
  },
  {
    ...
    order: 4,
    heroImage: "/images/pillar-1-header-ad-creative-production.webp",
  ...
  teamMembers: [
    {
      ...
      isFounder: true,
      linkedin: "https://www.linkedin.com/in/olha-yevtushenko-41a801395/",
      externalPortfolio: "https://olhayevtushenko.com",
      instagram: "https://www.instagram.com/olhayevtushenko/",
      expertise: ["Performance Marketing", "Google Ads", "Meta Ads", "Creative Direction", "AI Visuals", "Visual Thinking"],
    },
    {
      id: "denys",
      slug: "denys-demyanyshyn",
      name: "Denys Demyanyshyn",
      location: "Hamburg",
      roleKey: "roleDenys",
      focusKey: "memberDenysFocus",
      isFounder: false,
      linkedin: "https://www.linkedin.com/in/denys-demyanyshyn-655049388/",
      expertise: ["KI Online Marketing", "Marketing AI Specialist", "Performance", "A/B Testing", "Data Logic"],
    },
    {
      id: "ralph",
      slug: "ralph-kindermann",
      name: "Ralph Kindermann",
      location: "Berlin",
      roleKey: "roleRalph",
      focusKey: "memberRalphFocus",
      isFounder: false,
      linkedin: "https://www.linkedin.com/in/ralph-kindermann-86502638b/",
      expertise: ["E-Mail Marketing", "CRM", "Automation", "Data-Driven Marketing", "Lifecycle Marketing"],
    },
    {
      id: "yahya",
      slug: "yahya-yildirim",
...
export const CASES: CaseProject[] = [
  {
    ...
    title: "Luminous Aura",
    year: "2026",
    coverImage: "/images/cases/luminous-aura-1.webp",
    visuals: [
      { src: "/images/cases/luminous-aura-1.webp", alt: "Luminous Aura — dark marble backdrop with gold particle atmosphere" },
      { src: "/images/cases/luminous-aura-2.webp", alt: "Luminous Aura — serum bottle detail, gold light refraction on marble" },
      { src: "/images/cases/luminous-aura-3.webp", alt: "Luminous Aura — texture close-up, mineral surface and product interaction" },
      { src: "/images/cases/luminous-aura-4.webp", alt: "Luminous Aura — product elevated on dark marble plinth, controlled lighting" },
      { src: "/images/cases/luminous-aura-5.webp", alt: "Luminous Aura — overhead composition, gold particle dispersion" },
      { src: "/images/cases/luminous-aura-6.webp", alt: "Luminous Aura — editorial full-system frame, cinematic dark luxury" },
    ],
    aiVariant: "assisted",
  ...
  },
  {
    ...
    year: "2026",
    coverImage: "/images/cases/vitality-pulse-1.webp",
    visuals: [
      { src: "/images/cases/vitality-pulse-1.webp", alt: "Vitality Pulse — kinetic energy serum, dynamic diagonal composition" },
      { src: "/images/cases/vitality-pulse-2.webp", alt: "Vitality Pulse — macro detail, water droplets on glass, tactile energy texture" },
      { src: "/images/cases/vitality-pulse-3.webp", alt: "Vitality Pulse — motion-driven product placement, energy tension and liquid dynamics" },
      { src: "/images/cases/vitality-pulse-4.webp", alt: "Vitality Pulse — saturated directional highlight against dark controlled ground" },
      { src: "/images/cases/vitality-pulse-5.webp", alt: "Vitality Pulse — gold liquid crown splash, kinetic motion frozen in time" },
      { src: "/images/cases/vitality-pulse-6.webp", alt: "Vitality Pulse — full editorial frame, kinetic visual system complete" },
    ],
    aiVariant: "assisted",
  ...
  },
  {
    ...
    title: "Essence Drift",
    year: "2026",
    coverImage: "/images/cases/essence-drift-1.webp",
    visuals: [
      { src: "/images/cases/essence-drift-1.webp", alt: "Essence Drift — soft haze atmosphere, glass refraction and diffused light" },
      { src: "/images/cases/essence-drift-2.webp", alt: "Essence Drift — fragrance bottle in layered diffused light, atmospheric depth" },
      { src: "/images/cases/essence-drift-3.webp", alt: "Essence Drift — editorial atmospheric frame, translucence and suspended time" },
      { src: "/images/cases/essence-drift-4.webp", alt: "Essence Drift — hero fragrance bottle, teal smoke atmosphere, gold cap detail" },
      { src: "/images/cases/essence-drift-5.webp", alt: "Essence Drift — bottle silhouette in dense fog, warm-cool atmospheric gradient" },
      { src: "/images/cases/essence-drift-6.webp", alt: "Essence Drift — serum on dark marble, glass refraction and gold liquid warmth" },
    ],
    aiVariant: "assisted",
  ...
  },
  {
    ...
    title: "Neural Glow",
    year: "2026",
    coverImage: "/images/cases/neural-glow-cover.webp",
    visuals: [
      { src: "/images/cases/neural-glow-cover.webp", alt: "Neural Glow — neon serum bottle with bioluminescent neural network pattern, tech-forward hero" },
      { src: "/images/cases/neural-glow-2.webp", alt: "Neural Glow — gold energy glow on dark tech grid, atmospheric abstract texture" },
      { src: "/images/cases/neural-glow-4.webp", alt: "Neural Glow — circuitry grid with illuminated gold nodes, tech precision pattern" },
      { src: "/images/cases/neural-glow-5.webp", alt: "Neural Glow — neon fiber-optic wave system, blue-gold bioluminescent flow" },
      { src: "/images/cases/neural-glow-6.webp", alt: "Neural Glow — neural network visualization, glowing synaptic connections on dark field" },
      { src: "/images/cases/neural-glow-3.webp", alt: "Neural Glow — wireframe geometry structure, precision-engineered tech aesthetic" },
    ],
    aiVariant: "generated",
    anchor: "neural-glow",
