...
- 🔵 **Offen (geplant):** Hub-**AI-Q&A via OMM-Backend** — server-seitiger Gemini-Call über das CSP-erlaubte `opus-magnum-…run.app` (Cross-Repo, Backend-Endpoint `/api/hub-qa` + Frontend-Wiring).
