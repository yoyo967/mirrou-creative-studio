...
| 2026-06-02 | **Code-Kennzahlen gegen `src/` verifiziert** | Echte Werte: **34 Komponenten** (2 Totcode: `ParticleCanvas`, `ParallaxImage`), **16 Routen**, **280 Sitemap-URLs**, **346 statische HTML-Seiten** (43 Routen-Instanzen × 8 Sprachen + Redirect + `/deck`). Berichte sagten „37+"/Totcode/Phantom-`BrandLogos`; TEAM_BRIEFING „30 Routen"; „345" überall →346. Vereinheitlicht + Artefakte (HTML/3 PDFs) neu gerendert; AUDIT.md §4/§7. Strategie-Pivot vermerkt: **Kontaktformular nicht mehr via HubSpot, sondern eigenes EU-E-Mail-System + GitHub-Anbindung (Fallback eigenes CRM)** — siehe [[project-contact-form-hubspot]]. | OPUS PRIME (Claude Opus 4.8) |
