...
- **Du verantwortest:** Dark-Luxury-Designsystem (Onyx + Gold), Brandbook, 12 Logo-Varianten, alle Visuals, die 4 Demo-Case-Studies (Luminous Aura, Vitality Pulse, Essence Drift, Neural Glow), Hybrid Production.
...
- **Du verantwortest:** Frontier-Firm-Architektur (5 Perplexity-Spaces, MCP-Stack), die **Website selbst** (React/TS/Tailwind, 8 Sprachen, GCP), Compliance-Architektur, Positionierung/ICP, Growth/Outreach, Projektsteuerung.
...
- **Qualität:** Lighthouse **Desktop 100/100/100/100**, **Mobile 81/97/100/100** (Rev. `00041-pfg`) · **6/6 Security-Header** · 0 npm-Sicherheitslücken
