...
export const CLUSTERS = [
    // PILLAR 1 — Performance Creative
    {
        ...
        status: "published",
        tldr: "Die besten Hooks in Beauty-Ads 2026 öffnen mit Pain Points, Texturshots oder kontraintuitiven Aussagen. Vermeide generische Lifestyle-Cold-Opens, 'Hi, ich bin'-Opener und Logo-First-Animationen — sie erzeugen sofort 'Werbung'-Erkennung und werden weggescrollt.",
        faq: [
            {
    ...
    },
    {
        ...
        status: "published",
        tldr: "Creative Fatigue erkennt man an vier Datenpunkten: sinkende Hook-Rate, steigender CPM, Frequency über 3,5 und sinkendes Klickvolumen bei stabiler Conversion-Rate. Stop-Regel: Wenn zwei der vier Indikatoren über 7 Tage außerhalb der Toleranz liegen — nicht warten, bis ROAS einbricht.",
        faq: [
            {
    ...
    // PILLAR 2 — Creative Engine
    {
        ...
        readingTimeMinutes: 5,
        status: "published",
        tldr: "Eine valide Creative-Hypothese hat drei Bausteine: die Variable (was du änderst), die Erwartung (welcher KPI sich wie ändert) und die Begründung (warum du das vermutest). Template: 'Wir vermuten, dass [konkrete Variante] für [Zielgruppe] zu [KPI-Delta] führt — weil [evidenzbasierte Begründung].'",
        faq: [
            {
    ...
    },
    {
        ...
        readingTimeMinutes: 6,
        status: "published",
        tldr: "Ein Learning-Log ist eine strukturierte Datenbank aller Creative-Tests mit sieben Pflichtfeldern: Datum/Test-ID, Hypothese, Setup, Ergebnis, Verifikation, generalisierbare Erkenntnis, nächster Test. Nach 6–12 Monaten kompoundieren die Einträge zu echter Marketing-Intelligenz.",
        faq: [
            {
    ...
    // PILLAR 3 — Beauty E-Commerce
    {
        ...
        readingTimeMinutes: 7,
        status: "published",
        tldr: "Fünf Verschiebungen prägen D2C-Beauty in DACH 2026: TikTok Shop als eigenständiger Sales-Channel, schärfere Compliance (HWG, Cosmetics Regulation, EU AI Act), KI-gestützte Käufer-Recherche (ChatGPT, Perplexity), Retention vor Akquise und das Ende reiner Aspirational-Ästhetik zugunsten von Identifikation.",
        faq: [
            {
    ...
    // PILLAR 4 — Foto + KI Hybrid
    {
        ...
        status: "published",
        tldr: "Ab August 2026 müssen KI-generierte Werbeinhalte in der EU gekennzeichnet werden. Sichtbarer Hinweis am Visual + C2PA-Metadaten + Plattform-Labels (Meta, TikTok) sind die drei empfohlenen Kennzeichnungs-Wege. Strafen: bis 15 Mio. € oder 3 % des Weltumsatzes. Mirrou kennzeichnet bereits seit Tag 1.",
        faq: [
            {
...
export const clustersByPillar = (slug) => CLUSTERS.filter((c) => c.pillar === slug).sort((a, b) => new Date(b.publishedAt).getTime() - new Date(a.publishedAt).getTime());
export const findPillar = (slug) => PILLARS.find((p) => p.slug === slug);
export const findCluster = (slug) => CLUSTERS.find((c) => c.slug === slug);
export const SITE = {
    name: "Mirrou Creative Studio",
    shortName: "Mirrou",
    tagline: "Performance Creative Studio",
    description: "Mirrou Creative Studio — Performance Creatives für Beauty-, Health- & Lifestyle-Brands. High-End-Fotografie, KI-Visuals und systematisches Creative-Testing als messbare Creative-Engine. Creative Direction: Olha Yevtushenko.",
...
export const PRESS_DOWNLOADS = [
    {
        ...
        available: true,
        description: "High-resolution press portraits of Olha Yevtushenko for editorial and media use.",
    },
    {
        ...
        available: true,
        description: "Studio thesis, dual-city architecture, and 2026 editorial direction. For journalist reference.",
    },
    {
        ...
        rightsLabel: "Editorial use with credit",
        available: true,
        description: "~60 curated high-resolution images: studio, cases, location. Credits and captions included.",
    },
    {
        ...
        rightsLabel: "Editorial reference, with credit",
        available: true,
        description: "All four Mirrou visual systems documented: Luminous Aura, Vitality Pulse, Essence Drift, Neural Glow.",
    },
];
export const CASES = [
    {
